...
import ProductHeader from "./ServiceHeader";
...
function servicesAndCategories(props) {
  const dispatch = useDispatch();
  const product = useSelector(selectService);
  ...
  useDeepCompareEffect(() => {
    function updateProductState() {
      ...
      if (productId === "new") {
         ...
         * Get Product data
         */
        dispatch(getService(productId)).then((action) => {
          /**
